                ...
                <main className="row-span-2 w-full">
                    <div className="bg-gray-50 flex items-center justify-between px-4 py-4 border-b lg:py-6">
                        ...
                        <a
                            ...
                            target="_blank"
                            className="px-4 py-2 text-sm text-white bg-indigo-500 font-medium rounded-md bg-primary hover:bg-indigo-400 focus:outline-none focus:ring focus:ring-primary focus:ring-offset-1 focus:ring-offset-white"
                        >
                            Se tornar premium
                        </a>
                    </div>
